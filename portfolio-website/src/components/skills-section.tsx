...
export default function SkillsSection() {
  return (
    <section className="outer bg-accent relative flex w-full items-center justify-center rounded-4xl">
      <div className="inner flex w-full max-w-2xl flex-col [--card-header-height:64px] [--section-heading-height:92px] sm:max-w-4xl sm:[--card-header-height:92px] sm:[--section-heading-height:192px]">
        <h2
        ...
        <div className="flex flex-col px-2 py-8 sm:px-4">
          {skillCategories.map((skillCategory: SkillCategory, i) => (
            <Card
              className="sticky h-[35vh] p-2 sm:p-4"
              style={{
